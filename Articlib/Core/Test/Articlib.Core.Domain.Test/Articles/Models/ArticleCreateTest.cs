...
public class ArticleCreateTest : UnitTest
{
    ...
    {
        var result = Article.Create(passValidator, TV.Articles.Id(), TV.Articles.Url, Id<User>.Empty, DateTime.UtcNow);
    ...
    {
        var result = Article.Create(failValidator, TV.Articles.Id(), null!, TV.Users.Id(), DateTime.UtcNow);
