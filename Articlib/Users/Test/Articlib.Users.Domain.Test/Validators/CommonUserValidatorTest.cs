...
public class CommonUserValidatorTest : UnitTest
{
    ...
    {
        var result = User.Create(testObj, TV.Users.Id(), TV.Users.Email, TV.Users.Name);
    ...
    {
        var result = User.Create(testObj, TV.Users.Id(), new Email(""), TV.Users.Name);
    ...
    {
        var result = User.Create(testObj, TV.Users.Id(), TV.Users.Email, new Name(""));
